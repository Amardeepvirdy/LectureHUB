...
def course_dashboard(request):
    ...
    data1 =  databaseconnection.retrieve_lecture_sentiment(engine, request.session["lec_id_ele"])
    data2 =  databaseconnection.retrieve_lecture_rating(engine, request.session["lec_id_ele"])
